...
<head>
    ...
    <script type="text/javascript" language="javascript" src="http://libs.baidu.com/jquery/1.9.0/jquery.js" charset="utf-8"></script>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-9">
          ...
          <div class="xx">
            <form action="/kitchen/user/registSubmit.ms" method="post">
                <div class="form-group">
                 
                  <input type="text" class="form-control" value="${userVo.phonenumber }"  id="inputPhonenumber" placeholder="手机号" name="phonenumber" >
                  <font color="red"><label id="confirmPhonenumber">${errors.phonenumberError }</label></font>
                </div>
                <div class="form-group">
                  
                  <input type="text" class="form-control" value="${userVo.username }" id="inputUsername" placeholder="用户名" name="username">
                  <font color="red"><label id="confirmUsername">${errors.usernameError }</label></font>
                </div>
                <div class="form-group">
                  
                  <input type="password" class="form-control" value="${userVo.password }" id="exampleInputPassword1" placeholder="密码" name="password">
                  <font color="red"><label>${errors.passwordError }</label></font>
                </div>
                <div class="form-group">
                  
                  <input type="password" class="form-control" value="${userVo.password }" id="exampleInputPassword1" placeholder="确认密码">
                </div>
                
                <div>
                                        验证码：<input type="text" name="imageCode" size="3" />
