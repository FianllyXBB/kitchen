...
<div>
	...
	<table style="width: 50%;margin:0 auto;">
		...
		<c:forEach items="${pageData.pageData }" var="item" varStatus="status">	
			...
			<td>${item.username}</td>
			<td><a class="openDialogA" data-val="/kitchen/backCategory/beforeUpdateCategory.ms" onclick="modify(this,400,400)">修改</a></td>
			</tr>
		</c:forEach>
	</table>
	<bb:page ordercolumn="${pageData.ordercolumn }" url="/kitchen/backUserAction/selectAll.ms" 
